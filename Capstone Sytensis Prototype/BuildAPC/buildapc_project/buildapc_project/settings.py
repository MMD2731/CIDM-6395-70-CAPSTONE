"""
Django settings for buildapc_project project.
...
ROOT_URLCONF = 'buildapc_project.urls'
...
WSGI_APPLICATION = 'buildapc_project.wsgi.application'
...
SECURE_HSTS_SECONDS = 31536000  # (1 year), include subdomains, and preload
